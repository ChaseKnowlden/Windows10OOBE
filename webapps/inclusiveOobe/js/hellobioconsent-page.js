(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/hellobioconsent-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'jsCommon/knockout-helpers', 'legacy/bridge', 'legacy/events', 'hellobioconsent-vm', 'oobesettings-data', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, HelloBioConsentViewModel) => {
