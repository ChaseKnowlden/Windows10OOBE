        ...
        constructor(resources, isInternetAvailable, targetPersonality) {
                ...
                },
                {
                    ...
                    buttonClickHandler: () => {
                        if (!this.processingFlag()) {
                            ...
                            bridge.invoke("CloudExperienceHost.Hello.reportBioDataStorageConsentResponseWrapper", response).done(() => {
            ...
            this.onLearnMoreButtonClick = () => {
                if (!this.processingFlag()) {
                    ...
                    oobeSettingsData.updateLearnMoreContentForRender(doc, document.documentElement.dir, isInternetAvailable, this.resources.HelloLearnMoreNavigationError, targetPersonality, "WindowsHello");
                    this.processingFlag(false);
                }
            };
